...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        titleTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, DisplayUtils.sp2px(context, titleTextSize));

        titleNormalColor = ta.getColor(R.styleable.BottomBarItem_textColorNormal, StringUtils.resColor(context, R.color.bbl_999999));
        titleSelectedColor = ta.getColor(R.styleable.BottomBarItem_textColorSelected, StringUtils.resColor(context, R.color.bbl_ff0000));

        marginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, DisplayUtils.dip2px(context, marginTop));
        ...
        unreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, DisplayUtils.sp2px(context, unreadTextSize));
        unreadTextColor = ta.getColor(R.styleable.BottomBarItem_unreadTextColor, StringUtils.resColor(context, R.color.white));
        unreadTextBg = ta.getDrawable(R.styleable.BottomBarItem_unreadTextBg);

        msgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, DisplayUtils.sp2px(context, msgTextSize));
        msgTextColor = ta.getColor(R.styleable.BottomBarItem_msgTextColor, StringUtils.resColor(context, R.color.white));
    ...
    public void setNormalIcon(int resId) {
        setNormalIcon(StringUtils.resDrawable(context, resId));
    }
    ...
    public void setSelectedIcon(int resId) {
        setSelectedIcon(StringUtils.resDrawable(context, resId));
    }
    ...
    public static final class Builder {
        ...
        public BottomBarItem create(int normalIconId, int selectedIconId, String text) {
            return create(StringUtils.resDrawable(context, normalIconId), StringUtils.resDrawable(context, selectedIconId), text);
        }
